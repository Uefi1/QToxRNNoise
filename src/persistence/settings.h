...
public:
    ...
    bool getEnableNoiseSuppression() const override;
    void setEnableNoiseSuppression(bool newValue) override;
    ...
    SIGNAL_IMPL(Settings, enableNoiseSuppressionChanged, bool newValue)
