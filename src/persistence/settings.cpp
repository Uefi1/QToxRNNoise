...
void Settings::loadGlobal()
{
    ...
    inGroup(s, "Audio", [this, &s] {
        ...
        enableNoiseSuppression =
            s.value("enableNoiseSuppression", enableNoiseSuppression).toBool();
...
void Settings::saveGlobal()
{
    ...
    inGroup(s, "Audio", [this, &s] {
        ...
        s.setValue("enableNoiseSuppression", enableNoiseSuppression);
...
bool Settings::getEnableNoiseSuppression() const
{
    const QMutexLocker<QRecursiveMutex> locker{&bigLock};
    return enableNoiseSuppression;
}

void Settings::setEnableNoiseSuppression(bool newValue)
{
    if (setVal(enableNoiseSuppression, newValue)) {
        emit enableNoiseSuppressionChanged(newValue);
    }
}
