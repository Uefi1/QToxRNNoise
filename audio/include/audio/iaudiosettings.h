...
public:
    ...
    virtual bool getEnableNoiseSuppression() const = 0;
    virtual void setEnableNoiseSuppression(bool newValue) = 0;
    ...
    DECLARE_SIGNAL(enableNoiseSuppressionChanged, bool newValue);
};
